        ...
        this.games = [
            {
                ...
                review: "Одна из лучших RPG 2020-го. Глубокий сюdea, невероятно immersive мир и свобода выбора. Графика потрясающая, особенно с новыми DLC. Идеально для поклонников жанра.",
                genre: "RPG, Экшен",
            ...
            },
            {
                ...
                review: "Мастер-класс RPG от CD Projekt RED. Не просто игра, а полноценный эпос с потрясающей историей, персонажами и механиками. Обязательно для всех фанатов жанра - 100 часов удовольствия гарантировано.",
                genre: "RPG, Фэнтези",
                developer: "CD Projekt Red",
            ...
            },
            {
                ...
                review: "Шедевр FromSoftware с невероятно deep лором и бой системами. Созданный Ричардомь Христианом, мир заполнен секретами и трудностями. Совершенство для любителей challenging игр.",
            ...
            },
            {
                ...
                review: "Отличное продолжение с новой механикой PVE. Больше тимфайта и героями. Хорошо для casual игроков, но с элементами соревнования.",
            ...
            },
            {
                ...
                review: "Великолепное заключение серии с emotional историей, красивой графикой и глубоким лором. Атрей отлично acceptability.",
            ...
            },
            {
                ...
                detailedDescription: "Hogwarts Legacy — это ролевая игра с открытым миром, действие которой происходит в мире, впервые представленном в книгах о Гарри Поттера. Отправляйтесь в приключение и находите фантастических зверей, создавайте зелья и изучайте заклинания.",
                review: "Отличное фанатское приключение в Hogwarts. Полно секретов, заданий и магии. Идеально для поклонников Potter-универса, даже если не фанат игр.",
    ...
    showGameDetails() {
        ...
        setTimeout(() => {
            ...
            const detailsHTML = `
                ...
                <p class="game-review"><strong>Обзор:</strong> ${currentGame.review}</p>
